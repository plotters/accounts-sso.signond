    ...
    public:
        ...
        */
        ...
        /*!
            ...
            @param readOutput Flag whether to save or not the std::out output of the executed application.
            @returns true upon success, false otherwise.
        */
        bool makeCall(const QString &appPath, const QStringList &args, bool readOutput = false);

        /*!
            @returns the raw untrimmed output of the last process called with makeCall
                     and readOutput set to true
        */
    ...
    */
    ...
    struct CryptsetupHandler
    {
        ...
        */
        ...
        /*!
            Adds a key to a free encryption header slot. This operation is to be executed if
            at least one key is already set in the LUKS header.
            @param  deviceName, name of the device.

...
#define SIGNOND_DAEMON_INTERFACE        SIGNOND_STRING(SIGNOND_SERVICE_PREFIX ".AuthService")
#define SIGNOND_IDENTITY_INTERFACE      SIGNOND_STRING(SIGNOND_SERVICE_PREFIX ".Identity")
#define SIGNOND_AUTH_SESSION_INTERFACE  SIGNOND_STRING(SIGNOND_SERVICE_PREFIX ".AuthSession")
